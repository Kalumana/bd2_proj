# Generated by Django 4.1.10 on 2023-11-28 18:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('analysing', 'Em analise'), ('producing', 'A produzir'), ('produced', 'Produzido'), ('delivery', 'Entregue')], default='ANALYSING', max_length=9)),
        ...
        migrations.AddField(
            ...
            name='type_labor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.labor'),
        ),
        migrations.AddField(
